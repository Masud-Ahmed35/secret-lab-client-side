...
const Home = () => {
    return (
        <section>
            ...
            <div className="px-4 mb-10 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-12 bg-gray-800 text-gray-100">
                <h2 className="mb-8 text-4xl font-bold leading-none text-center">What do we offer in our courses?</h2>
