...
const CourseDetails = () => {
    ...
    const { id, title, img, price, description, ratings, view, comments } = data;
    ...
    return (
        <div className='mt-10 m-2 mb-10 lg:ml-24' ref={ref}>
            <div className="max-w-lg p-4 shadow-md bg-gray-200 text-gray-900">
                ...
                <div className="space-y-4 mt-4 mb-5">
                    ...
                    <p className='text-lg font-semibold'>Course Fees: <span className='text-2xl font-bold text-orange-600'>${price}</span></p>
