...
const Login = () => {
    ...
    const { googleLogin, gitHubLogin, signIn, resetPassword } = useContext(AuthContext);
    ...
    return (
        <div className=''>
            <div className="mt-10 mb-10 flex flex-col max-w-md mx-auto p-6 rounded-md sm:p-10 bg-gray-800 text-gray-100">
